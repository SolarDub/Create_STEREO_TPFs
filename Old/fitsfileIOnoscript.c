...
//  const char coorfilename[] = "MyStars_h1A_K2-EPIC_details.txt";
  char coorfilename[] = "/Users/pwilliams/Documents/Programming/C/Projects/c/Tests/fitsfileIO/starLists/GoodStars.txt";
//  char coorfilename[] = "/Users/pwilliams/Documents/Programming/C/Projects/c/Tests/fitsfileIO/starLists/OneStar.txt";
//  char coorfilename[] = "/Users/pwilliams/Documents/Programming/C/Projects/c/Tests/fitsfileIO/starLists/MyStarsTest.txt";
...
//  for (is = 0; is < 1; is++){   /* Loop through star list */
  for (is = 0; is < 16; is++){   /* Loop through star list */
//  for (is = 0; is < 8; is++){   /* Loop through star list */

/***************************************************************************/

  for (orbit = 10; orbit < 11; orbit++){
...
//  Reinitialise time mm:ss if beginning after this particular date/time: 2021/02/19,00:09   
    if (date_ymd[0] == 2021)
    {
...
//  Switch time mm:ss on this particular date/time: 2021/02/19,00:09   
      if (date_ymd[0] == 2021)
      {
...
/******************************
  ...
  /* Create filename (! means to overwrite existing file) */
    sprintf(outputfile, "STEREO_HI-1A_r%02d_%s.fits", orbit, star);
